  ...
  return (
    ...
    <>
       <div className="px-8 py-12">
        <h1 className="text-3xl font-bold mb-4">Melanjutkan Film</h1>
        <Slider {...settings}>
          {images.map((img, index) => (
            <div key={index} className="px-2">
              ...
              <div className="flex items-center absolute bottom-12 px-5 font-bold">
                
                <p className="">{img.title}</p>
                <div className="flex ms-32 items-center">
                  <img src={img.icon} alt="icon-star" />
                  <p>{img.score}</p>
                </div>
              </div>
            </div>
